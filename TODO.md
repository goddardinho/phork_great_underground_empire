...
- [x] **Canonical NPCs Phase 1 & 2** - Phase 1 (Combat Foundation) and Phase 2 (Thief NPC) complete with authentic Thief implementation, theft mechanics, combat integration, movement behavior, and comprehensive testing ✅ **COMPLETE!** *v1.5.1-phase2 → v1.5.2*
- [x] **Canonical NPCs Phase 3: Troll NPC** - Complete Troll implementation with bridge guarding behavior, payment/toll mechanics, combat alternative, and comprehensive testing (100% success rate) ✅ **COMPLETE!** *v1.5.2*
- [ ] **Canonical NPCs Phase 4: Cyclops NPC** - Implement Cyclops with ancient creature behaviors, sleep/wake states, feeding mechanics, and staircase blocking 🚧 **CURRENT** *v1.5.3+*
- [ ] **Canonical NPCs Phase 5-6** - Remaining NPCs: Master, Woodsman, Sailor *v1.6.0*
